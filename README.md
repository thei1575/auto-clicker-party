...
This contains a Tampermonkey userscript and a deliberately small WebSocket relay.
...
The script already uses the public relay at `wss://clicker.oz1tnj.dk`; no server address needs to be entered.
